...
def fbconnect():
    ...
    '''
        ...
        have tosplit the token first on commas and select the first index which
        gives us the key : valuefor the server access token then we split it on
...
def editRestaurant(restaurant_id):
    ...
    if editedRestaurant.user_id != login_session['user_id']:
        ...
        "{alert('You are not authorized to edit this restaurant.Please create'"
