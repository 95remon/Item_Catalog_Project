...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     ...
                     " versions of the dish serving mostly the skin"
...
menuItem3 = MenuItem(user_id=1, name="Gyoza", description="light seasoning of"
                     " Japanese gyoza with salt and soy sauce, and"
                     " in a thin gyoza wrapper",
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     ...
                     "jasmine tea jelly, grass jelly, caramel, cream, and"
                     " freshly made mochi", price="$4.50", course="Dessert",
...
menuItem5 = MenuItem(user_id=1, name="Aloo Gobi Burrito", description="Vegan"
                     ...
                     " curry sauce, potatoes (aloo), fried cauliflower "
...
menuItem1 = MenuItem(user_id=1, name="Shellfish Tower", description="Lobster,"
                     " shrimp, sea snails, crawfish, stacked"
...
menuItem2 = MenuItem(user_id=1, name="Broiled salmon", description="Salmon"
                     " fillet marinated with fresh herbs"
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken", description="Chicken"
                     ...
                     " mix(chilli, tamarind among others) and slow cooked"
                     " in a cylindrical clay or metal oven which gets its"
...
menuItem1 = MenuItem(user_id=1, name="Chantrelle Toast", description="Crispy"
                     " Toast with Sesame Seeds slathered with"
